...
public class ItemTrangChuAdapter extends RecyclerView.Adapter<ItemTrangChuAdapter.ITemiewHolder> {
    ...
    private List<model_itemKhamPha> mListKS;
    ...
    public void setData(List<model_itemKhamPha> list){
        this.mListKS = list;
    ...
    public void onBindViewHolder(@NonNull ITemiewHolder holder, int position) {
        model_itemKhamPha KS = mListKS.get(position);
    ...
    {
        Intent intent = new Intent(mContext, ChitietItem_Activity.class);
