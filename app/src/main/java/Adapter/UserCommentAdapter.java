...
public class UserCommentAdapter extends ArrayAdapter {
    ...
    ArrayList<model_UserComment> arrayList;

    public UserCommentAdapter(@NonNull Context context, int resource, ArrayList<model_UserComment>arrayList) {
    ...
    {
        model_UserComment cmt = arrayList.get(position);
        if(convertView==null)
        {
