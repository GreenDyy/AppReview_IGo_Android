...
public class DangNhap_Activity extends AppCompatActivity {
    ...
    TextView cmdRegister,cmdForgotPassword, ktmk;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ktmk = (TextView) findViewById(R.id.txtkiemtramatkhau);
        ...
        cmdLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    ktmk.setVisibility(View.VISIBLE);
                    ktmk.setTextColor(Color.RED);
                    ktmk.setText("Tên đăng nhập hoặc mật khẩu không đúng!");
