...
import Model.model_UserComment;
...
import Model.model_IdUser;
import me.relex.circleindicator.CircleIndicator;

public class ChitietItem_Activity extends AppCompatActivity {
    ...
    ListView lvComment;
    //-------------------------Khai báo các list------------------------------
    ArrayList<model_UserComment> listUserComment =new ArrayList<model_UserComment>(); //ds các comment trog item
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_web.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ChitietItem_Activity.this, "Load Web", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn_danhgia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ChitietItem_Activity.this, Comment_Activity.class);
                intent.putExtra("IDUser", IDUser);
                intent.putExtra("idItem", idItem);
                Toast.makeText(ChitietItem_Activity.this, idItem, Toast.LENGTH_SHORT).show();
        ...
        userCommentAdapter = new UserCommentAdapter(ChitietItem_Activity.this, R.layout.item_user, listUserComment);
...
//-------main ở trên ^---
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==1 && resultCode == RESULT_OK && null != data)
        {
            ...
            Toast.makeText(ChitietItem_Activity.this, picturepath, Toast.LENGTH_SHORT).show();
            cursor.close();
    ...
    public void insertTableSave(String IdAccout, String IdItem)
    {
        ...
        {
            Toast.makeText(ChitietItem_Activity.this, "Bạn đã lưu địa điểm này rồi!", Toast.LENGTH_SHORT).show();
        }
        else
        {
            Toast.makeText(ChitietItem_Activity.this, "Lưu địa điểm thành công!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void data1Item(String id_item)
    {
        ...
        {
            Toast.makeText(ChitietItem_Activity.this, "Rac", Toast.LENGTH_SHORT).show();
            return;
        }
        else
        {
    ...
    public void imageItem(String id_item) {
        ...
        Cursor cursor = database.rawQuery(sql, null);
        if (cursor.getCount() == 0) {
            Toast.makeText(ChitietItem_Activity.this, "Lỗi, ko load dc ảnh", Toast.LENGTH_SHORT).show();
            return;
        } else {
            while (cursor.moveToNext()) {
    ...
    public void dataComment(String id_item) {
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                listUserComment.add(new model_UserComment(IDAccount, fullname, Title, Comment, Rating, model_UserComment.convertStringToBitmapFromAccess(this, "ImageUser/"+Avatar)));
            }
        }
        cursor.close();
    }
    ...
    //hàm lấy ảnh
    ArrayList<model_hinhanhitem> listAnhBia = new ArrayList<>();
    public ArrayList<model_hinhanhitem> getListPhoto()
    {
        ...
        {
            listAnhBia.add(new model_hinhanhitem(model_hinhanhitem.convertStringToBitmapFromAccess(ChitietItem_Activity.this, "ImageItem/" + image)));
        }
        return listAnhBia;
    }
}