...
public class model_Chitietitem {
    private String iditem, itemname, typename, addresscode, describeitem;
    private float ratings;
    private int pathimg;

    public model_Chitietitem(String iditem, String itemname, String typename, String addresscode, String describeitem, float ratings, int pathimg) {
        this.iditem = iditem;
