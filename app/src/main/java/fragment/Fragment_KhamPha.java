...
import Model.model_itemKhamPha;
...
public class Fragment_KhamPha extends Fragment {
    ...
    private void getListKhachSan() {
        List<model_itemKhamPha> list = new ArrayList<>();
        ...
        while (c.isAfterLast() == false) {
            ...
            Bitmap bm = model_itemKhamPha.converPath(mContext, imagePath);
            model_itemKhamPha ks = new model_itemKhamPha(idItem, nameitem, bm, diem);
            list.add(ks);
            c.moveToNext();
        }
    ...
    private List<model_itemKhamPha> getListNhaHang() {
        List<model_itemKhamPha> list = new ArrayList<>();
